...
FROM 'C:\Users\Marco\Desktop\Postgres SQL\Chapter_09\MPI_Directory_by_Establishment_Name.csv'
...
--Using length() for checking malformed values
SELECT length(zip),
...
COPY state_regions
FROM 'C:\Users\Marco\Desktop\Postgres SQL\Chapter_09\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
