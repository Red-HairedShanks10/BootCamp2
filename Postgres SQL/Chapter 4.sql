...
CREATE TABLE us_counties_2010 (
    ...
    -- THISPANIC OR LATINO, AND NOT HISPANIC OR LATINO BY RACE
...
FROM 'C:\Users\Marco\Desktop\Postgres SQL\Chapter_04\us_counties_2010.csv'
WITH (FORMAT CSV, HEADER);


--DROP TABLE us_counties_2010 CASCADE;
...
FROM 'C:\Users\Marco\Desktop\Postgres SQL\Chapter_04\supervisor_salaries.csv'
WITH (FORMAT CSV, HEADER);
...
COPY us_counties_2010
TO 'C:\Users\Marco\Desktop\Postgres SQL\Chapter_04\us_counties_export.txt'
...
TO 'C:\Users\Marco\Desktop\Postgres SQL\Chapter_04\us_counties_latlon_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
...
TO 'C:\Users\Marco\Desktop\Postgres SQL\Chapter_04\us_counties_mill_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
