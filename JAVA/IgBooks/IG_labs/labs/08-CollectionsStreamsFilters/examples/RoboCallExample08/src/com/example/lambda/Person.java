...
//ch8..1
import com.example.lambda.extra_streamExamples.Gender;
import java.util.ArrayList;
import java.util.List;

/**
 * Person class will be used for creating 
 * a generic collection of its type
 *
 * 
 */
public class Person {
  ...
  //create a short list of different person objects
  //then stores them in people list
