...
BlogPost.create({
    ...
    them everything at this time of year. They go like this:`}, (error, blogpost) =>{
    ...
    BlogPost.find({}, (error, blogspot) =>{
        ...
        //find certain  documents with specified title
        BlogPost.find({
            ...
            //find certain  documents with "The" in the title
            BlogPost.find({
