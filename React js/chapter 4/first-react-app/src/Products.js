...
constructor(props){
    super(props);
this.products = this.getProducts(); // pg 41--- assign returned getProducts results to products property (inside contructor)
}
...
render() {
    ...
    <Product key={product.productName} data={product} />//key will help identify removed,added, or modified productName 
    );
    return (
    <div>
    <ul>{listProducts}</ul>{/** */}
